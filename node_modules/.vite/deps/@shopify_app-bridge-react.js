...
function vr() {
  return Ce || (Ce = 1, function() {
    ...
    var je = false, ke = false, De = false, Ae = false, Fe = false, ee;
...
` + a[l].replace(" at new ", " at ");
        ...
        J = false, U.current = u, Ye(), Error.prepareStackTrace = o;
      }
    ...
    function Ve(e, r, t, n, o) {
      {
        ...
        for (var i in e)
          if (u(e, i)) {
            ...
            a && !(a instanceof Error) && (V(o), p("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", n || "React class", t, i, typeof a), V(null)), a instanceof Error && !(a.message in ce) && (ce[a.message] = true, V(o), p("Failed %s type: %s", t, a.message), V(null));
          }
      }
    }
    ...
    function Xe(e, r) {
      {
        var t = function() {
          he || (he = true, p("%s: `key` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", r));
        };
    ...
    function Ze(e, r) {
      {
        var t = function() {
          ye || (ye = true, p("%s: `ref` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", r));
        };
...
false ? H.exports = dr() : H.exports = vr();
var Oe = H.exports;
var pr = (0, import_react.forwardRef)(function({ open: E, onShow: w, onHide: m, children: P, ...S }, b) {
  const [s, c] = (0, import_react.useState)(), { titleBar: C, modalContent: d } = import_react.Children.toArray(P).reduce(
    (v, _) => {
    ...
    { modalContent: [] }
  ), g = s ? import_react_dom.default.createPortal(d, s.content) : null;
  return (0, import_react.useEffect)(() => {
    s && (E ? s.show() : s.hide());
  }, [s, E]), (0, import_react.useEffect)(() => {
    if (!(!s || !w))
