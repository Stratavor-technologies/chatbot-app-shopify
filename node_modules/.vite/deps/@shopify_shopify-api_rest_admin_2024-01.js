...
var require_customer = __commonJS({
  "node_modules/@shopify/shopify-api/rest/admin/2024-01/customer.js"(exports) {
    ...
    var Customer = class extends base_1.Base {
      ...
      static search(_a) {
        var { session, order = null, query = null, limit = null, fields = null, returnFullResponse = false } = _a, otherArgs = tslib_1.__rest(_a, ["session", "order", "query", "limit", "fields", "returnFullResponse"]);
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
          const response = yield this.request({
            http_method: "get",
            operation: "search",
          ...
          return returnFullResponse ? response : response === null || response === void 0 ? void 0 : response.body;
        });
      }
...
var require_gift_card = __commonJS({
  "node_modules/@shopify/shopify-api/rest/admin/2024-01/gift_card.js"(exports) {
    ...
    var GiftCard = class extends base_1.Base {
      ...
      static search(_a) {
        var { session, order = null, query = null, limit = null, fields = null, created_at_min = null, created_at_max = null, updated_at_min = null, updated_at_max = null, returnFullResponse = false } = _a, otherArgs = tslib_1.__rest(_a, ["session", "order", "query", "limit", "fields", "created_at_min", "created_at_max", "updated_at_min", "updated_at_max", "returnFullResponse"]);
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
          const response = yield this.request({
            http_method: "get",
            operation: "search",
