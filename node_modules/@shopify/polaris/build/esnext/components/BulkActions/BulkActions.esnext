...
import { getVisibleAndHiddenActionsIndices, getActionSections, instanceOfMenuGroupDescriptor, isNewBadgeInBadgeActions, instanceOfBulkActionListSection } from './utilities.esnext';
...
import { BulkActionsMeasurer } from './components/BulkActionsMeasurer/BulkActionsMeasurer.esnext';
...
const BulkActions = /*#__PURE__*/forwardRef(function BulkActions({
  ...
  }, /*#__PURE__*/React.createElement(CheckableButton, checkableButtonProps), paginatedSelectAllMarkup), /*#__PURE__*/React.createElement("div", {
  ...
  }, promotedActionsMarkup)), actionsMarkup))));
});
